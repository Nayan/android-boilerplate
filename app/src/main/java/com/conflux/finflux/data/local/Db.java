...
import com.conflux.finflux.data.model.Name;
import com.conflux.finflux.data.model.Profile;
...
public class Db {
    ...
    public abstract static class RibotProfileTable {
        ...
        public static final String ACTIVATION_TABLE = "activation";
        ...
        public static final String CREATE_ACTIVATION = "CREATE TABLE "+ACTIVATION_TABLE+" ( identifier INTEGER PRIMARY KEY AUTOINCREMENT, "+
                "is_activated TINYINT, activation_date DATETIME, end_date DATETIME, activation_key TEXT );";

        public static ContentValues toContentValues1() {
            ContentValues values = new ContentValues();
            values.put("is_activated", true);
            values.put("activation_date", new SimpleDateFormat("yyyy-MM-dd").format(new Date()));
            values.put("end_date", new SimpleDateFormat("yyyy-MM-dd").format(new Date()));
            values.put("activation_key", "5199909");
            return values;
        }

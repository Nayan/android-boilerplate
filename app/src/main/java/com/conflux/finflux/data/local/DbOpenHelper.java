...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "finflux.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        try {
            ...
            db.execSQL(Db.RibotProfileTable.CREATE_ACTIVATION);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        //db.execSQL("DROP TABLE IF EXISTS " + Db.RibotProfileTable.ACTIVATION_TABLE);
        onCreate(db);
    }
